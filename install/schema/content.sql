...
('month',1,1,1);;
INSERT INTO `<!-- $DB_PREFIX$ -->config` (`db_version`,`name`,`url`,`comment`,`time_format`,`template`,`footer`,`active`,`cookie_name`,`cookie_path`) VALUES
('0.02','<!-- $SITE_NAME$ -->', 'http://localhost/', 'Sourceforge.net', 'h:i A', 1, '<a href="http://sourceforge.net"><img src="http://sflogo.sourceforge.net/sflogo.php?group_id=223968&amp;type=1" width="88" height="31" border="0" type="image/png" alt="SourceForge.net Logo" /></a><br />Powered by Community CMS', 1, 'cms_session', '/');;
