...
('adm_calendar','Calendar Module','Allow a user to access the calendar manager module',0),
('adm_calendar_edit_date','Calendar Edit','Allow a user to access the calendar edit module',0),
('adm_calendar_import','Import Events','Allow a user to import calendar events',0),
('adm_calendar_locations','Manage Locations','Allow a user to manage calendar locations',0),
