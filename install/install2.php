...
$content .= '<tr><td>Database Name</td><td><input type="text" name="db_name" id="db_name" /></td></tr>'."\n";
$content .= '<tr><td>Database User</td><td><input type="text" name="db_user" id="db_user" /></td></tr>'."\n";
$content .= '<tr><td>Database Password</td><td><input type="text" name="db_pass" id="db_pass" /></td></tr>'."\n";
$content .= '<tr><td>Database Table Prefix</td><td><input type="text" name="db_pfix" id="db_pfix" value="comcms_'.rand(1000,9999).'_" /></td></tr>'."\n";
