...
<tr><td class="row1" valign="top">Content:</td><td class="row1"><textarea name="update_content" rows="30">'.stripslashes($page_message['text']).'</textarea></td></tr>
...
$content .= '</select><input type="text" name="start_day" maxlength="2" size="2" value="'.$start_date[2].'" /><input type="text" name="start_year" maxlength="4" size="4" value="'.$end_date[0].'" /><br />
End:<br />';
...
$content .= '</select><input type="text" name="end_day" maxlength="2" size="2" value="'.$end_date[2].'" /><input type="text" name="end_year" maxlength="4" size="4" value="'.$end_date[0].'" /></td></tr>
