...
function display_admin() {
	...
	$template_page->scripts = '<link type="text/css"
		...
		tinyMCE.init({
			...
			theme : "advanced",
			skin : "o2k7",
			plugins : "style,layer,table,save,advhr,advimage,advlist,advlink,comcmsfilelink,cleanupstyles,iespell,insertdatetime,preview,searchreplace,print,contextmenu,paste,directionality,spellchecker,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras",
			...
			theme_advanced_buttons2 : "cut,copy,paste,pastetext,pasteword,|,search,replace,|,bullist,numlist,|,outdent,indent,|,undo,redo,|,link,unlink,filelink,image,cleanup,|,forecolor,backcolor",
